...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props){
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "479af0d77226cd42cfde5cda63810cb3694cc00d69b66a05c392aae5eb705760"));
    ...
    private CfnCluster createMskCluster() {
        // Count distinct AZs from the subnets
        int azCount = (int) vpc.getPrivateSubnets().stream()
                .map(ISubnet::getAvailabilityZone)
                .distinct()
                .count();

        int brokerCount = azCount; // Minimum valid = one broker per AZ (or multiple)
